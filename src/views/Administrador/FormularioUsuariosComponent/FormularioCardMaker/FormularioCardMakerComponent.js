...
import { postUserExternoCardMaker } from '../../../../Controller/Controller';
...
const FormularioCardMakerComponent = ( {isAdmin} ) => {
    ...
    const RegisterUser = async() =>{
        ...
        const register = await postUserExternoCardMaker(formData)
        if(register === "OK"){
            setError(false)
                            ...
                            <div className="card-body">
                                <form className="forms-sample" onSubmit={handleSubmit}>
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <select className="form-control" id="FormControlSelectDepartment" onChange={(e) => setRol(e.target.value)} defaultValue={rolUsuario}>
...
export default FormularioCardMakerComponent;